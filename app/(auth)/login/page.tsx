    ...
    <>
      ...
      <div className="flex flex-col gap-3">
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-background px-4 py-2.5 text-sm font-medium text-neutral-700 dark:text-neutral-200 transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800"
        >
          <GitHubIcon />
      ...
      <p className="text-center text-[13px] text-neutral-600 dark:text-neutral-400 mt-4">
